...
class LogicPurchaseOfferCommand(LogicCommand):
    ...
    def execute(self, calling_instance, fields):
        ...
        if fields["Unk1"] == 21:
            ...
            for i,v in player_data["OwnedBrawlers"].items():
                v["Skins"].append(464)
                if 462 and 477 and 468 and 472 and 478 in v["Skins"]:
                	player_data["OwnedPins"].append(678)
        ...
        if fields["Unk1"] == 19:
            ...
            for i,v in player_data["OwnedBrawlers"].items():
                v["Skins"].append(462)
                if 477 and 464 and 468 and 472 and 478 in v["Skins"]:
                	player_data["OwnedPins"].append(678)
                	player_data["OwnedPins"].append(679)
                	player_data["OwnedPins"].append(680)
                	player_data["OwnedPins"].append(681)
        ...
        if fields["Unk1"] == 20:
            ...
            for i,v in player_data["OwnedBrawlers"].items():
                v["Skins"].append(468)
                if 462 and 464 and 477 and 472 and 478 in v["Skins"]:
                	player_data["OwnedPins"].append(678)
                	player_data["OwnedPins"].append(679)
                	player_data["OwnedPins"].append(680)
                	player_data["OwnedPins"].append(681)
        ...
        if fields["Unk1"] == 23:
            ...
            for i,v in player_data["OwnedBrawlers"].items():
                v["Skins"].append(472)
                if 462 and 464 and 468 and 477 and 478 in v["Skins"]:
                	player_data["OwnedPins"].append(678)
                	player_data["OwnedPins"].append(679)
                	player_data["OwnedPins"].append(680)
                	player_data["OwnedPins"].append(681)
        ...
        if fields["Unk1"] == 24:
            ...
            for i,v in player_data["OwnedBrawlers"].items():
                v["Skins"].append(477)
                if 462 and 464 and 468 and 472 and 478 in v["Skins"]:
                	player_data["OwnedPins"].append(678)
                	player_data["OwnedPins"].append(679)
                	player_data["OwnedPins"].append(680)
                	player_data["OwnedPins"].append(681)
        ...
        if fields["Unk1"] == 25:
            ...
            for i,v in player_data["OwnedBrawlers"].items():
                v["Skins"].append(478)
                if 462 and 464 and 468 and 472 and 477 in v["Skins"]:
                	player_data["OwnedPins"].append(678)
                	player_data["OwnedPins"].append(679)
                	player_data["OwnedPins"].append(680)
                	player_data["OwnedPins"].append(681)
        ...
        if fields["Unk1"] == 3:
            	db_instance = DatabaseHandler()
            	player_data = json.loads(db_instance.getPlayerEntry(calling_instance.player.ID)[2])
            	player_data["Coins"] = player_data["Coins"] + 142
            	db_instance.updatePlayerData(player_data, calling_instance)
            	Messaging.sendMessage(24104, {"Socket": calling_instance.client, "ServerChecksum": 0, "ClientChecksum": 0, "Tick": 0})
        if fields["Unk1"] == 9:
            	db_instance = DatabaseHandler()
        ...
        if fields["Unk1"] == 27:
            	db_instance = DatabaseHandler()
            	player_data = json.loads(db_instance.getPlayerEntry(calling_instance.player.ID)[2])
            	player_data["OwnedBrawlers"][52] = {'CardID': 417, 'Skins': [360], 'Trophies': 0, 'HighestTrophies': 0, 'PowerLevel': 1, 'PowerPoints': 0, 'State': 2}
            	player_data["Gems"] = player_data["Gems"] - 109
            	db_instance.updatePlayerData(player_data, calling_instance)
            	Messaging.sendMessage(24104, {"Socket": calling_instance.client, "ServerChecksum": 0, "ClientChecksum": 0, "Tick": 0})
        if fields["Unk1"] == 28:
            	db_instance = DatabaseHandler()
            	player_data = json.loads(db_instance.getPlayerEntry(calling_instance.player.ID)[2])
            	player_data["OwnedBrawlers"][51] = {'CardID': 410, 'Skins': [352], 'Trophies': 0, 'HighestTrophies': 0, 'PowerLevel': 11, 'PowerPoints': 0, 'State': 2}
